...
index_img: https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/Arduino_1.8.9_和_VS_code兼容乱码问题/下载.png
...
![20190517输出乱码](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/Arduino_1.8.9_和_VS_code兼容乱码问题/20190517输出乱码.png)
但是可以正常的编译和下载，仅是乱码问题。下张图片显示上传成功。

![20190517输出乱码2](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/Arduino_1.8.9_和_VS_code兼容乱码问题/20190517输出乱码2.png)
