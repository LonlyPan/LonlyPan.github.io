...
![USART_Signal_Description_](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/ATSAME54_SERCOM硬件设计问题/USART_Signal_Description_.png)
<!--more-->
其余上下文并没有对**SERCOM引脚与USART信号**对应关系有约束说明，而在**SERCOM I2C**相同小结处的表格却做了明确约束，如下：
![IIC_Signal_Description](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/ATSAME54_SERCOM硬件设计问题/IIC_Signal_Description.png)
...
![USART_CTRLA](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/ATSAME54_SERCOM硬件设计问题/USART_CTRLA.png)
...
![SPI_CTRLA](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/ATSAME54_SERCOM硬件设计问题/SPI_CTRLA.png)
## I2C引脚
