...
layout: post
title: "小书匠软件使用笔记"
index_img: https://cdn.jsdelivr.net/gh/LonlyPan/LonlyPan.github.io@hexo_source/hexo_images/小书匠软件使用笔记/unnamed.png
date: 2021-02-26
updated: 2021-02-26
hide: false
...
![enter description here](https://cdn.jsdelivr.net/gh/LonlyPan/LonlyPan.github.io@hexo_source/hexo_images/小书匠软件使用笔记/操作与设置界面.png)
...
![enter description here](https://cdn.jsdelivr.net/gh/LonlyPan/LonlyPan.github.io@hexo_source/hexo_images/小书匠软件使用笔记/申请token界面.png)
...
![enter description here](https://cdn.jsdelivr.net/gh/LonlyPan/LonlyPan.github.io@hexo_source/hexo_images/小书匠软件使用笔记/token值.png)

4、然后就是你的仓库名了，直接复制就好了。

![enter description here](https://cdn.jsdelivr.net/gh/LonlyPan/LonlyPan.github.io@hexo_source/hexo_images/小书匠软件使用笔记/仓库名2.png)
...
![enter description here](https://cdn.jsdelivr.net/gh/LonlyPan/LonlyPan.github.io@hexo_source/hexo_images/小书匠软件使用笔记/仓库名.png)
...
和url前缀即可，
```
https://cdn.jsdelivr.net/gh/LonlyPan/LonlyPan.github.io@hexo_source/
```
...
![enter description here](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/小书匠软件使用笔记/1654258509243.png)
