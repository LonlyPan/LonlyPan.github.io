...
index_img: https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/Hexo博客搭建-Github/662949ef-1d9a-4b56-bc56-5e26c9936cf1.png
...
![powershell_87](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/Hexo博客搭建-Github/powershell_87.png)
...
![node_-v](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/Hexo博客搭建-Github/node_-v.png)

### 3、安装Hexo

Hexo 就是我们的个人博客网站的框架， 这里需要自己在电脑常里创建一个文件夹，可以命名为 hexo blog，Hexo 框架与以后你自己发布的网页都在这个文件夹中。创建好后，进入文件夹中，按住**shift键，右击鼠标**，点击命令行

![Hexo_blog](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/Hexo博客搭建-Github/Hexo_blog.png)

在 PowerShell 输入 `npm install -g hexo-cli `,安装完成后，命令行会出现下面两个警告：

![hexo_warringpng](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/Hexo博客搭建-Github/hexo_warringpng.png)
...
![fsevent_warring](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/Hexo博客搭建-Github/fsevent_warring.png)
...
![npm_fsevent_warring](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/Hexo博客搭建-Github/npm_fsevent_warring.png)
...
![set-execution](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/Hexo博客搭建-Github/set-execution.png)
3. 选择 Y 或者 A ，就好了  
...
![hexo_g](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/Hexo博客搭建-Github/hexo_g.png)

接着输入`hexo s`,会显示本地的网站地址，复制到浏览器，就可以看到我们建立好的博客网站。

![local_site](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/Hexo博客搭建-Github/local_site.png)
...
![add_git](https://lonly-hexo-img.oss-cn-shanghai.aliyuncs.com/hexo_images/Hexo博客搭建-Github/add_git.png)
