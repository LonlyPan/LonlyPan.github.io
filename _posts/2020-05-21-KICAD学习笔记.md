...
1. 要查看所有 Gerber 文件，请转到 KiCad 项目管理器并单击 GerbView 图标。 在下拉菜单或图层管理器中，选择 图形图层1 。 单击 **文件 → 打开 Gerber 文件** 或单击图标 ![enter description here](https://LonlyPan.github.io/images/Posts/2020-05-21-KICAD学习笔记/gerber_file.png) 。 选择并打开所有生成的 Gerber 文件。 注意它们如何一个显示在另一个之上。
...
![enter description here](https://LonlyPan.github.io/images/Posts/2020-05-21-KICAD学习笔记/制造属性.png)
