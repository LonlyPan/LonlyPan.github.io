---
layout: post
show_title: "2020-12-03-LittlevGL-学习笔记"
title: 2020-12-03-LittlevGL 学习笔记
date: 2020-11-05
...
![enter description here](https://LonlyPan.github.io/images/Posts/2020-12-03-LittlevGL_学习笔记/1606962374407.png)
...
![enter description here](https://LonlyPan.github.io/images/Posts/2020-12-03-LittlevGL_学习笔记/1606962536983.png)
```
...
![enter description here](https://LonlyPan.github.io/images/Posts/2020-12-03-LittlevGL_学习笔记/1606962601758.png)
```
...
![enter description here](https://LonlyPan.github.io/images/Posts/2020-12-03-LittlevGL_学习笔记/1606973910550.png)
```
/*创建一个屏幕*/
...
- 
![](https://LonlyPan.github.io/images/Posts/2020-12-03-LittlevGL_学习笔记/1606979430122.png)
...
![enter description here](https://LonlyPan.github.io/images/Posts/2020-12-03-LittlevGL_学习笔记/1606979543577.png)
```
#include "../../lv_examples.h"
...
![enter description here](https://LonlyPan.github.io/images/Posts/2020-12-03-LittlevGL_学习笔记/1606979605995.png)
```
#include "../../lv_examples.h"
...
![enter description here](https://LonlyPan.github.io/images/Posts/2020-12-03-LittlevGL_学习笔记/1606979690907.png)
```
#include "../../lv_examples.h"
...
![](https://LonlyPan.github.io/images/Posts/2020-12-03-LittlevGL_学习笔记/1606979811531.png)
```
#include "../../lv_examples.h"
...
![enter description here](https://LonlyPan.github.io/images/Posts/2020-12-03-LittlevGL_学习笔记/1606979916503.png)
...
![enter description here](https://LonlyPan.github.io/images/Posts/2020-12-03-LittlevGL_学习笔记/1606980103626.png)
...
![enter description here](https://LonlyPan.github.io/images/Posts/2020-12-03-LittlevGL_学习笔记/1606980179758.png)
...
![enter description here](https://LonlyPan.github.io/images/Posts/2020-12-03-LittlevGL_学习笔记/1606980309881.png)
```c
#include "../../lv_examples.h"
...
![enter description here](https://LonlyPan.github.io/images/Posts/2020-12-03-LittlevGL_学习笔记/Transition_properties.gif)
```
#include "../../lv_examples.h"
...
![](https://LonlyPan.github.io/images/Posts/2020-12-03-LittlevGL_学习笔记/1606981343856.png)
```
#include "../../lv_examples.h"
...
![enter description here](https://LonlyPan.github.io/images/Posts/2020-12-03-LittlevGL_学习笔记/1606981634954.png)
...
lv_obj_t * big_arc; // 大的环形弧块
lv_obj_t * tiny_arc;// 小的环形弧块
lv_obj_t * out_arc; // 外弧线
lv_obj_t * in_arc1;  // 内弧线
lv_obj_t * in_arc2;
...
static char buf[30];//储存浮点数转换后的字符
...
/* 用于填充背景色,目前没找到填充背景的函数,使用没有角度值的圆弧空间代替 */
    ...
    scr1_task = lv_task_create(show_scr1_loader, 30,LV_TASK_PRIO_HIGHEST, NULL);
...
/*
 void lv_ex_img_1(void)
 {
     ...
     lv_img_set_src(img1, &bilibili2);
     lv_obj_align(img1, NULL, LV_ALIGN_CENTER, 0, 0);
     lv_img_set_zoom(img1,230);
 }
*/
...
void loop()
{
	speech_process();
	/*
	if(ELAPSED(millis(), run_times)){
		run_times = millis()+5000;
		speeech_wake_up();
        switch(mode_flag){
        	case 0:
        		mode_flag++;
