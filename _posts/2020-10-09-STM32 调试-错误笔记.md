...
再结合参考手册描述：
![enter description here](https://LonlyPan.github.io/images/Posts/2020-10-09-STM32_调试-错误笔记/GPIO模拟配置.png)
...
突然无法下载，于是尝试使用 `ST-LINK utility` 连接下载，依然无法连接失败。有尝试使用`ST-LINK upgrade` 连接，弹窗显示报错 "the content of STLink is corrupt" ，意思说是仿真器损坏，貌似遇到这个问题的人不多，用windows版程序升级固件的时候报这个错，解决办法是用 java 版的升级程序来升级固件，就是上面第二个压缩包中带的jar程序，当然你的系统要有java运行环境。

在 [官网](https://www.st.com/en/development-tools/stsw-link007.html) 下载STSW-LINK007，解压下，文件中找到 STLinkUpgrade.jar ，双击运行即可。更新一次固件

我这里更新了固件之后依然是无法使用的，连接不上，于是使用 `ST-LINK utility` 连接下载器，从软件内再更新一次固件，就好了。要升级固件两次？？？
![enter description here](https://LonlyPan.github.io/images/Posts/2020-10-09-STM32_调试-错误笔记/ST-LINK_utility_固件更新.png)
...
![图 2](../images/Posts/2020-10-09-STM32%20%E8%B0%83%E8%AF%95-%E9%94%99%E8%AF%AF%E7%AC%94%E8%AE%B0/.png)  
...
![图 1](../images/Posts/2020-10-09-STM32%20%E8%B0%83%E8%AF%95-%E9%94%99%E8%AF%AF%E7%AC%94%E8%AE%B0/ST-LINK%20utility%20%E9%85%8D%E7%BD%AE.png)  
...
![enter description here](https://LonlyPan.github.io/images/Posts/2020-10-09-STM32_调试-错误笔记/修改路径包含.png)
