...
3. 下载以下文档：
   - 数据手册：`Description of STM32F4 HAL and low-layer drivers`
   - 参考手册：`STM32F401xB/C and STM32F401xD/E advanced Arm®-based 32-bit MCUs` 
   - 编程手册：`STM32 Cortex®-M4 MCUs and MPUs programming manual` 
